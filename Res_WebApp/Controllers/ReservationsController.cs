...
namespace Res_WebApp.Controllers
{
    public class ReservationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ResId,Name,UserId,NumPeople,Date")] Reservations reservations)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ResId,Name,UserId,NumPeople,Date")] Reservations reservations)
        {
            if (id != reservations.ResId)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ReservationsExists(reservations.ResId))
                    {
                        return NotFound();
                    }
                    else
